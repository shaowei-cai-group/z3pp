...
private:
  ...
  // while the 'Solver' facade class is defined in 'cadical.h' (here) but
  // implemented in 'solver.cpp'.  The reason for this naming mismatch is,
  // that we want to use 'cadical.h' for the library header (this header
  ...
  // followings lines are copies of similar code in 'cad-inttypes.h' but we
  // want to keep the 'cadical.h' header file stand-alone.
