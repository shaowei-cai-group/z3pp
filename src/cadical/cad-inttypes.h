...
// 'cad-inttypes.h' in order to please the 'MinGW' cross-compiler (we are using
...
// 'cadical.h' as we do not want to require users of the library to
// include another header file (like this one) beside 'cadical.h'.
