...
//
// Note, that 'Solver' is defined in 'cadical.h' and 'solver.cpp', while
...
struct External {
  ...
  int fixed (int elit) const;   // Implemented in 'internal.h'.
  ...
  // For debugging and testing only.  See 'solution.h' for more details.
  //
