...
#define IS_MAIN_SOLVER(i)  (i == main_solver_offset)
    ...
    */
    ...
    // [Lin] new user-scope literal `lit`, all clauses become `(-lit) -> clause`
    //
    ...
    // [Lin] unassigned all vars. It is different from smt operator push/pop for incremental solving
